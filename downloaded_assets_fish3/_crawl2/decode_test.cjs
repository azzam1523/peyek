...
const tpl='xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx'.split('');
const idx=[]; for(let i=0;i<tpl.length;i++) if(tpl[i]!=='-') idx.push(i);
function decode(b){ if(!b||b.length!==22) return b; const t=tpl.slice();
